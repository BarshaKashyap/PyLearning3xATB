...
my_list = [1, 2, 3]
my_list2 = [1, 2, 3]
print(my_list is my_list2)# this returns false because my_list and my_list2 are two different list objects that happen to have the same content, my_list is my_list2
